...
/**
 * Estado de conversión de una orden de Tiendanube dentro del CRM (FR-007a,
 * data-model.md §`tn_ordenes`). Mismos 5 valores y transiciones que
 * `App\Enums\MercadoLibre\EstadoConversion` pero definido de forma
 * independiente (research.md R6): integraciones sin acoplamiento entre sí.
 */
enum EstadoConversion: string
{
    ...
    /** ¿Es válida la transición de este estado hacia $destino? (data-model.md §`tn_ordenes`). */
