...
/**
 * Historial de interacciones con la API de Mercado Libre, escrito por
 * ClienteMercadoLibre. Nunca contiene credenciales (FR-034) — el saneado en
 * registrar() es previo a persistir, no posterior.
 */
class MercadoLibreOperacionLog extends Model
{
    protected $table = 'ml_operaciones_log';

    public $timestamps = false;

    protected $fillable = [
        'operacion', 'metodo', 'endpoint', 'sentido', 'resultado',
        'codigo_http', 'duracion_ms', 'mensaje_error', 'payload_bloqueado',
    ...
    private const CAMPOS_SENSIBLES = ['access_token', 'refresh_token', 'client_secret', 'Authorization'];
