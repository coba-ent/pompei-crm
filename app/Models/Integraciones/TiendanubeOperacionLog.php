...
/**
 * Historial de interacciones con la API de Tiendanube, escrito por
 * ClienteTiendanube. Nunca contiene credenciales (FR-015) — el saneado en
 * registrar() es previo a persistir, no posterior.
 */
class TiendanubeOperacionLog extends Model
{
    protected $table = 'tn_operaciones_log';
    ...
    private const CAMPOS_SENSIBLES = ['access_token', 'Authentication'];
