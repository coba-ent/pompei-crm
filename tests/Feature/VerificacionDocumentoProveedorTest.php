 ...
 * Mismos casos que VerificacionDocumentoClienteTest, contra Proveedor.
 */
class VerificacionDocumentoProveedorTest extends TestCase
{
    use RefreshDatabase;

    public function test_cuit_valido_devuelve_aplica_y_valido_true(): void
    {
        $response = $this->getJson(route('proveedores.verificar-documento', [
