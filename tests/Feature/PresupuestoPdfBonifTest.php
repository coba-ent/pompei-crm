...
/**
 * PDF de Presupuesto: la columna "Bonif." muestra el % efectivo combinado (línea + Descuento
 * General), no sólo el descuento propio de línea — spec 098, User Story 2.
 */
class PresupuestoPdfBonifTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_bonif_muestra_el_descuento_general_cuando_la_linea_no_tiene_propio(): void
    {
        ...
        $html = view('presupuestos.pdf', ['presupuesto' => $presupuesto, 'datosEmpresa' => null])->render();
