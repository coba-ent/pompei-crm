...
/** Estado de sincronización de precio por vínculo (spec 018 ampliación, data-model.md §`tn_variante_producto` precio). */
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tn_variante_producto', function (Blueprint $table) {
            ...
            $table->timestamp('precio_sincronizado_en')->nullable()->after('precio_pendiente');
            $table->string('precio_error', 255)->nullable()->after('precio_sincronizado_en');
            $table->timestamp('precio_error_en')->nullable()->after('precio_error');
        });
    }
