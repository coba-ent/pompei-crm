								...
								<div class="dropdown header-profile2">
									<a class="nav-link p-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											<div class="header-media d-flex align-items-center justify-content-center bg-light rounded-circle" style="width:40px; height:40px;">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<div class="avatar avatar-md d-flex align-items-center justify-content-center bg-light rounded-circle">
														<i class="fas fa-user text-primary"></i>
													</div>
													<div>
											...
											<div class="card-body px-0 py-2">
												...
												<a href="{{ route('configuracion.mi-perfil.index') }}" class="dropdown-item ai-icon ">
												...
												<a href="{{ route('configuracion.index') }}" class="dropdown-item ai-icon ">
