  ...
  <div class="header-media d-flex align-items-center justify-content-center bg-light rounded-circle"
  ...
  <div class="products">
  <div
  class="avatar avatar-md d-flex align-items-center justify-content-center bg-light rounded-circle">
  <i class="fas fa-user text-primary"></i>
  </div>
  <div>
  ...
  <a href="{{ route('configuracion.mi-perfil.index') }}"
  ...
  stroke="#E55555" stroke-width="2" stroke-linecap="round"
  stroke-linejoin="round">
