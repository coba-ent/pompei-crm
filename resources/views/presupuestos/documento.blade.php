                    ...
                    <div class="col-md-4">
                        <table class="table table-sm">
                            @if ($presupuesto->descuento > 0)
                                ...
                                <tr><td>Descuento General ({{ rtrim(rtrim(number_format((float) $presupuesto->descuento_general_pct, 2, ',', '.'), '0'), ',') }}%)</td><td class="text-end">-$ {{ number_format((float) $presupuesto->descuento, 2, ',', '.') }}</td></tr>
                            @endif
