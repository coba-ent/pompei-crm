        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2 mb-3 align-items-center">
                    ...
                    <span id="dt-buttons-otros-ingresos"></span>
                    {{-- Selector de fecha "Emisión" del header, como en Contagram (informe 4.1). --}}
                ...
                {{-- Los 6 filtros del panel de Contagram (informe_contagram_ingresos.md 4.2):
                     Id, Categoría, Medio de Cobro, Estado del Cobro, Descripción y Usuario. --}}
                    ...
                    <div class="border rounded p-3">
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="filtro-buscar" class="form-control" placeholder="Contiene">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table id="tabla-otros-ingresos" class="table table-hover display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Estado</th>
                                <th>Id</th>
...
@vite(['resources/js/rango-emision.js', 'resources/js/otros-ingresos.js'])
