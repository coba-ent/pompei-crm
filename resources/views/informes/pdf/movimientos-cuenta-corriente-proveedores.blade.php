...
<head>
    <meta charset="utf-8">
    <title>Informe - Movimientos de Proveedores</title>
    <style>
...
<body>
    ...
    <h1>Informe - Movimientos de Proveedores</h1>
        ...
        <tbody>
            @forelse ($visibles as $m)
                <tr>
                    ...
                    <td>{{ $m['categoria'] }}</td>
                    <td class="num">{{ $fmt($m['total_compra']) }}</td>
                    <td class="num">{{ $fmt($m['pagado']) }}</td>
                    <td class="num">{{ $fmt($m['a_pagar']) }}</td>
