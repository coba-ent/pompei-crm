...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        @elseif ($puedeConvertir && \Illuminate\Support\Facades\Route::has('ingresos.tiendanube.convertir'))
            <li><a class="dropdown-item" href="{{ route('ingresos.tiendanube.convertir', $orden) }}">Crear Venta</a></li>
        @else
            <li>
