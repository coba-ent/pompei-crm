        ...
        <form id="form-ventas-ml">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-text">
                        Mercado Libre publica el stock de <strong id="ml-deposito-efectivo">{{ $depositoEfectivoMl?->nombre ?? '—' }}</strong>.
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-text">
                        ...
                        lo deja para que alguien lo apruebe desde Vinculación de publicaciones.
