        ...
        <div class="modal-content">
            <form id="form-proveedor" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            {{-- Campos adicionales del proveedor (dinámico, sólo de ESTE proveedor). --}}
                            <div id="campos-personalizados-container"></div>

                            {{-- Saldo inicial (plegable): apertura de la cuenta corriente
                                 del proveedor — Fecha + Monto (Contagram). --}}
                    ...
                    <h6 class="fw-bold mb-3">
                        <i class="fas fa-shopping-basket me-2 text-primary"></i>Compras
                        <i class="fas fa-question-circle text-info ms-1" style="cursor:help" data-bs-toggle="tooltip"
                           title="Los datos seleccionados aquí aparecerán por defecto en una nueva compra al elegir este proveedor"></i>
                    </h6>
                    <div class="row g-3 mb-2">
                        <div class="col-md-6">
                            <label class="form-label">Categoría Compras</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="nota_interna">
                        </div>
                    </div>
                    ...
                    <h6 class="fw-bold mb-3">
                        ...
                        <i class="fas fa-question-circle text-info ms-1" style="cursor:help" data-bs-toggle="tooltip"
                           title="Todos los comprobantes recibidos de este proveedor vendrán por defecto con estos datos de Facturación"></i>
                    </h6>
                    <div class="row g-3">
                        {{-- Columna izquierda --}}
                        <div class="col-lg-6">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn-guardar-proveedor">Guardar</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modal-eliminar-proveedor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Eliminar definitivamente este proveedor? Esta acción no se puede deshacer.
                Si el proveedor tiene productos asociados, sólo podrá inactivarse.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
