 ...
 *
 * Sin este archivo Laravel responde en inglés y con el nombre técnico de la columna
 * ("The cliente id field is required."), que es exactamente lo que llegaba al usuario en el toast
 * de los formularios de Venta/Compra/Presupuesto/NC-ND.
 *
 * `attributes` (al final) es la otra mitad del arreglo: traduce `cliente_id` → "Cliente", así que el
 * mensaje final queda "El campo Cliente es obligatorio." en vez de "El campo cliente id…".
 */
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute apareció en una filtración de datos. Elegí otro.',
    ],
    ...
    /**
     * Nombre "de negocio" de cada campo, para que el mensaje no exponga el nombre de la columna.
     *
     * Cubre los campos de los formularios de carga (Venta, Compra, Presupuesto, NC/ND) y sus ítems.
     * `items.*.x` traduce el campo dentro de cada renglón del detalle.
     */
    'attributes' => [
        ...
        'fecha_vto_cobro' => 'Vencimiento del Cobro',
        'fecha_vto_pago' => 'Vencimiento del Pago',
        'servicio_desde' => 'Servicio Desde',
        'servicio_hasta' => 'Servicio Hasta',
        'mes_imputacion_iva' => 'Mes de Imputación de IVA',
        'mes_imputacion' => 'Mes de Imputación',
        'tipo_comprobante' => 'Tipo de Comprobante',
        'nro_comprobante' => 'N° de Comprobante',
        'punto_venta_proveedor' => 'Punto de Venta del Proveedor',
        'numero_comprobante_proveedor' => 'N° de Comprobante del Proveedor',
        'cae_proveedor' => 'CAE del Proveedor',
        'cae_vencimiento_proveedor' => 'Vencimiento del CAE',
        'nota_cliente' => 'Nota para el Cliente',
        'nota_interna' => 'Nota Interna',
        'descripcion' => 'Descripción',
        'monto' => 'Monto',
        'tipo' => 'Tipo',
        'afecta_stock' => 'Afecta Stock',
        'venta_id' => 'Venta',
        'compra_id' => 'Compra',

        // Descuentos
        'descuento_general_tipo' => 'Tipo de Descuento General',
        'descuento_general_pct' => 'Descuento General (%)',
        'descuento_general_monto' => 'Descuento General ($)',
        ...
        'items.*.descuento_pct' => 'Descuento del ítem (%)',
        'items.*.iva_pct' => 'IVA del ítem',

        // Conceptos (percepciones / impuestos internos / intereses)
        'conceptos' => 'Conceptos',
        'conceptos.*.tipo' => 'Tipo de concepto',
        'conceptos.*.concepto' => 'Concepto',
        'conceptos.*.monto' => 'Monto del concepto',

        // Gastos / Otros Ingresos / Tesorería
        'fecha' => 'Fecha',
        'fecha_pago' => 'Fecha de Pago',
        'cuenta_tesoreria_id' => 'Cuenta de Tesorería',
        'subcategoria_id' => 'Subcategoría',
        'medio_pago' => 'Medio de Pago',
        'medio_cobro' => 'Medio de Cobro',

        // Otros
        'submit_token' => 'Token del formulario',
        'nombre' => 'Nombre',
