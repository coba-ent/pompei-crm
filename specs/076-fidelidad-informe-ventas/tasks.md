...
- [X] T029 [US2] Crear `app/Exports/Informes/InformeVentasDetalladoExport.php`: una hoja, KPIs arriba, 44 columnas, recorrido en chunks de 1.000 como el export resumen
